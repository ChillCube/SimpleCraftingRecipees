...
```bash
clone-gd-addon https://github.com/ChillCube/SimpleCraftingRecipees.git
```

## Documentation
You can find the documentation at: https://github.com/ChillCube/SimpleCraftingRecipees/blob/main/DOCUMENTATION.md

## Deinstallation
### Linux
Run this in the root of your godot project:
```bash
remove-gd-addon SimpleCraftingRecipees
```
...
- [CraftBench](https://github.com/ChillCube/CraftBench)
